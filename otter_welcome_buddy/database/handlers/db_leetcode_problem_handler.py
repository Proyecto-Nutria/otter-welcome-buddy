...
from otter_welcome_buddy.database.models.cache.leetcode_problem_model import LeetcodeProblemModel


class DbLeetcodeProblemHandler:
    ...
    def insert_leetcode_problem(
        ...
        if not override:
            current_leetcode_problem_model = DbLeetcodeProblemHandler.get_leetcode_problem(
