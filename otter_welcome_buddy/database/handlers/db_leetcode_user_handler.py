...
from otter_welcome_buddy.database.models.external.leetcode_user_model import LeetcodeUserModel
...
class DbLeetcodeUser:
    ...
    def get_leetcode_user(
        ...
        try:
            leetcode_user_model: LeetcodeUserModel = UserModel.objects(user_id=user_id, guild=guild_id).get()
            return user_model
        except DoesNotExist:
            return None
